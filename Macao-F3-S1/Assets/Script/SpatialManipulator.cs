...
namespace Leo.HoloToolkitExtensions
{
    public class SpatialManipulator : MonoBehaviour
    {
        ...
        public void Manipulate(Vector3 manipulationData)
        {
            switch (Mode)
            {
                ...
                case ManipulationMode.Scale:
                    ...
                    break;
                case ManipulationMode.Scale_1_1:
                    break;
                case ManipulationMode.Scale_1_100:
                    break;
                case ManipulationMode.Walk:
                    break;
            }
        }
        ...
        {
            transform.RotateAround(transform.position, transform.up,  -manipulationData.x * RotateSpeed);
            //transform.RotateAround(transform.position,transform.right, manipulationData.y * RotateSpeed);
            //transform.RotateAround(transform.position, Camera.main.transform.forward,  manipulationData.z * RotateSpeed);
        }
